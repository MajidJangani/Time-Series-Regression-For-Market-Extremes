...
## Key Features
- **Objective**: Forecast upward and downward price deviations for GLD within a single trading session.
- **Data Source**: Historical price data from Yahoo Finance.
- **Tech Stack**: Python, Pandas, NumPy, scikit-learn, yfinance, pyfolio, Matplotlib.
- **Methodology**:
  - Time series regression with feature engineering.
